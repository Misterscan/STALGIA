...
**Interactive API Documentation (Swagger UI)** is available natively! Run the application and navigate to `http://localhost:8080/apidocs/` in your browser to explore, test, and interact with these endpoints dynamically.
